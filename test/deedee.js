...
describe('deedee', () => {
  ...
  describe('package.json', () => {
    ...
    it('should extract dependencies', () => {
      extractNodeOrBower(packageJson, 'dependencies').should.deep.equal(deps)
    })

    it('should extract devDependencies', () => {
      extractNodeOrBower(packageJson, 'devDependencies').should.deep.equal(
        devDeps
      )
    })
    ...
    it('should detect package.json properties', () => {
      ...
      detectNode(path.join(__dirname, 'fixture')).should.deep.equal({
        type: 'Node.js',
  ...
  describe('bower.json', () => {
    ...
    it('should extract dependencies', () => {
      extractNodeOrBower(bowerJson, 'dependencies').should.deep.equal(deps)
    })

    it('should extract devDependencies', () => {
      extractNodeOrBower(bowerJson, 'devDependencies').should.deep.equal(
        devDeps
      )
    })
    ...
    it('should detect bower.json properties', () => {
      ...
      detectBower(path.join(__dirname, 'fixture')).should.deep.equal({
        type: 'Bower',
        path: path.resolve(path.join(__dirname, 'fixture')),
        projectName: 'test',
        dependencies: deps,
  ...
  describe('composer.json', () => {
    ...
    it('should extract requires', () => {
      extractComposerJson(composerJson, 'require').should.deep.equal(
        composerRequire
      )
    })

    it('should extract require-devs', () => {
      extractComposerJson(composerJson, 'require-dev').should.deep.equal(
        composerRequireDev
      )
    })
    ...
    it('should detect composer.json require', () => {
      ...
      detectComposer(path.join(__dirname, 'fixture')).should.deep.equal({
        type: 'PHP/Composer',
        path: path.resolve(path.join(__dirname, 'fixture')),
